...
// Rotas para inserir dados manualmente
router.post('/inserirDados', autenticar, estufaController.inserirDadosClima);
router.post('/inserirAltura', autenticar, estufaController.inserirAltura);
